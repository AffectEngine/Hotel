...
router.register(r'rubric_rest', RubricViewSet)
...
urlpatterns = [
	...
	# path('api/v1/rubriclist', RubricViewSet.as_view({'get': 'list'})),
	# path('api/v1/rubriclist/<int:pk>/', RubricViewSet.as_view({'put': 'update'})),
